...
export default function Portfolio(){
  return (
    <>
      ...
      <div className="hero" style={{backgroundImage:`url(${banner})`, minHeight:'25vh'}}>
      </div>

      <div className="section-title mb-5">
        <h1>Portfolio</h1>
        <p className="section-subtitle">Voici quelques-unes de mes réalisations.</p><div className="bar"></div>
      </div>
      ...
      <Container className="pb-5">
        <Row className="gy-4">
          ...
          <Col md={4}><PortfolioCard img={coder} title="Création d'une API" desc="Création d’une API RESTFULL publique" footer="PHP · SYMFONY" /></Col>
          <Col md={4}><PortfolioCard img={screens} title="Maquette d'un site web" desc="Création du prototype d'un site" footer="Réalisé avec FIGMA" /></Col>
        </Row>
      </Container>
    </>
  );
